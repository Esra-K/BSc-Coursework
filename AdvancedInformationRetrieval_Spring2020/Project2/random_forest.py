...
set1 = get_term_set('train.txt', subset_index=2)
set2 = get_term_set('test.txt', subset_index=2)
joint_set = set1 & set2

X_train, y_train = get_dataset(joint_set, 'train.txt', weight=5, subset_index=2)
...
clf=RandomForestClassifier(n_estimators=550, max_depth=64)
print('I got here')
